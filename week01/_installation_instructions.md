...
# These installation instructions are not necessary!
...
<!-- >
<img src="images/anacondaInstallers.png" alt="Screenshot of choice of Anaconda installers for Windows, MacOS, and Linux from the ">
-->
...
![Output from the command-line that shows the conda create command and how the solving environment looks while it is in process.](images/warning_message_conda2.png)
