...
<img src="images/intro_naiman1.png" alt="drawing" width="800" alt="A visualization of the Illustris cosmological computer simulations. Image shows dark matter filaments in purple and gas density in orange/red."/>

---

### My background

<img src="images/intro_naiman2.png" alt="drawing" width="800" alt="A visualization of the Illustris cosmological computer simulations with the phrase 'SCIENCE!' written on top."/>

---

### My background

<img src="images/intro_naiman3.png" alt="drawing" width="800" alt="A visualization of the Illustris cosmological computer simulations.  Arrows and text highlight the dark matter filaments, the orange/red gas and where it is brightest (densist).  The box size is shown as approximately 3e18 meters."/>

---

### My background

<img src="images/intro_naiman4.png" alt="drawing" width="800" alt="A visualization of the Illustris cosmological computer simulations.  Several zoom-in snapshots of high gas density show simulated galaxies which are either elliptical or spiral shaped (like our Milky Way galaxy)."/>
...
<img src="images/intro_naiman5.png" alt="drawing" height="400" alt="Diagram showing how visualizations (like that of the Illustris simulations) are made from the original simulation box.  A camera traces a ray through the simulation box to create each pixel of an image."/>
...
<img src="images/intro_naiman6.png" alt="drawing" height="400" alt="Figure from a scientific publication showing how different views of the same cosmological simulation will change if the way light is simulated to travel through the simulation changes based on chosen colors or opacity mappings (this is called a transfer function)."/>
...
<img src="images/intro_naiman7.png" alt="drawing" height="400" alt="Visualization from simulation of LSST field showing stars in the process of forming."/>
...
<img src="images/intro_naiman8.png" alt="drawing" height="400" alt="Visualization from the 'Solar Superstorms' showing the magnetic fields emerging from the Sun and passing the magnetosphere of Earth."/>
...
<img src="https://www.astronaiman.com/assets/img/digitization_project/figure_axis_reading_sm-1400.webp" height="500" alt="Image showing optical character recognition (OCR) applied to a technical image of the sky with declination (y) and right ascension (x) axis.  The raw OCR is processed into metadata to be added to the original image to give its location in the sky."/>
...
![Histogram of feedback from students showing the distribution of how much time they spend on the class.  The peak is around 5-8 hours, with a long tail up to 20-25 hours.](images/hwquestion.png)
...
<!-- JPN, change due dates of assignments as needed -->
...
There are 3 pathways (that I can see in this course, could be more!)
 ...
 1. "I am here to get better at programming and play with viz platforms"
    * Strategy:
       ...
       * do the Streamlit/Javascript/Jekyll parts
...
There are 3 pathways (that I can see in this course, could be more!)
 ...
 3. "I don't know/I am new to programming and I want to focus on that."
    * Strategy: 
       ...
       * do the Streamlit/Javascript/Jekyll parts, think about joining a group for the final project
       * if you're new to programming, do Streamlit/Javascript/Jekyll parts in class, and build on them for any assignments
...
# Pause to check out (parts of) Homework \#1
