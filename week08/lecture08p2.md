 ...
 * [`aggregate`](https://vega.github.io/vega-lite/docs/aggregate.html): operating over a collection of points -- `mean`, `sum`, `median`,
   `min`, `max`, `count` (next class)
 * [`filtering`](https://vega.github.io/vega-lite/docs/filter.html): for plotting subsets of data (next class)
