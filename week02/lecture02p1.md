...
<img src="https://clauswilke.com/dataviz/aesthetic_mapping_files/figure-html/temp-normals-vs-time-1.png" width="400px" alt="A line graph showing temperature fluctuations for a year in Death Valley, Houston, San Diego, Chicago.">

</div>

<div class="right">

<img src="https://clauswilke.com/dataviz/coordinate_systems_axes_files/figure-html/temperature-normals-polar-1.png" width="400px" alt="A circle graph showing temperature fluctuations for a year in Death Valley, Houston, San Diego, Chicago.">
...
<img src="diagrams/row_col.svg" alt="Diagram showing column/row." width="150"/>

<!--![](diagrams/hdf5pic.png)-->
<img src="images/hdf5pic.png" alt="Screenshot of information and layout of an HDF5 file." width="250"/>

<img src="images/jsonex.png" alt="Screenshot of the data layout of a JSON file." width="150"/>
...
<img src="images/viz_newdiagram.png" alt="Diagram first showing data stored on file, linked to a data reader (example is Python code), then linked to the visualization.">
...
<img src="images/elliexWickesTalk.png" alt="Marked up example code from plotly and Pandas documentation used to make a plot showing.  The image has been marked up to show where each assumption about the data is being made in the documentation (for example, that the data has specific columns or is structured as a table).">
...
<img src="images/viz_newdiagram2.png" alt="Diagram first showing data stored on file, linked to a data reader (example is Python code), then linked to the visualization.  An arrow and pop out text highlights that the middle, data reader portion uses embedded or custom data readers.">
...
||||||||||||||
|:-|-|-|-|-|-|-|-|-|-|-|-|-|
| By: Row | 11 | 21 | 31 | 41 | 12 | 22 | 32 | 42 | 13 | 23 | 33 | 43 |
| By: Column | 11 | 12 | 13 | 21 | 22 | 23 | 31 | 32 | 33 | 41 | 42 | 43 |
...
![Shows the top of a CSV file for the popular "automobiles" dataset with comma separated columns of mpg,cyl,displ,hp,weight,accel,yr,origin,name.](images/automobilesCSV.png)
...
![ASCII table with numbers 0, 3, 9 highlighted to correspond to "decimal" or row values of 48, 51, 57 in the table.](images/ASCII-Table2.jpeg)
