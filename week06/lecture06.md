...
<!-- .slide: data-background-image="images/brushlink_01.svg" data-background-size="80% auto" data-background-position="right 50% bottom 50%" alt="Simple graph with points." -->
...
<!-- .slide: data-background-image="images/brushlink_02.svg" data-background-size="80% auto" data-background-position="right 50% bottom 50%" alt="Two simple graphs, first is for variable 1 (x-axis) and variable 2 (y-axis), second is for variable 3 (x-axis) and variable 4 (y-axis)." -->
