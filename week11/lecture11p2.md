...
<img src="images/sci_canup.png" width="350" alt="A 2-column, 3-row panel visualization showing different snapshots of a simulation of a planetesimal collating with a proto-Earth."/>
...
<img src="images/sci_convection.png" width="700" alt="A slide from a simulation of a 'slab' of the Sun.  Background is visual of hydrodynamical simulation, overlaid are two graphs showing different variables (temperature, density, etc.) as a function of solar depth."/>
...
<img src="images/sci_flu.png" width="80%" alt="Map of the United States with flu risk density map overlaid with connections between major transportation hubs."/>
...
<img src="images/sci_genes.png" width="80%" alt="Two gene maps showing connections between various genes. Names of each gene use their technical 'phone numbers'."/>
...
<img src="images/basedonatruestory.jpg" width="80%" alt="An example of 'viz for the public' showing a list of various movies (e.g. Bohemian Rhapsody, Hidden Figures) with measures of how accurate they are.  Movie timelines are color coded by True, True-ish, False-ish, False, and Unknown categories."/>
...
<img src="images/hurricane.jpg" width="50%" alt="Cartoon showing four different views of the statement 'There is an eye at the center of the hurricane'.  In the upper left, we see the professor stating this fact, in the upper right we see a student imagining a mental model of a physically accurate hurricane, in the lower right we see a student imagining a big green eye in the center of a tornado, and in the bottom right panel we see a student pointing out there is the letter 'I' in the middle of the word 'hurricane'."/>
...
<img src="images/upgoerfive.png" width="70%" alt="Screenshot of the XKCD comic number 1133. This comic tries to explain a blueprint of the Saturn IV rocket using the 1000 most common words in the English language -- this results in many nonsensical or hard to explain phrases."/>
