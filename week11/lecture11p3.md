---
title: Lecture 10.3 - Streamlit & HuggingFace Introduction; VSCode
layout: lecture
description: >-
...
![A screenshot of the homepage of the Streamlit "hello world" example where a bit of code is used to generate a simple online application.](images/streamlit1.png)
...
![Screenshot of the HuggingFace logo.](https://huggingface.co/datasets/huggingface/brand-assets/resolve/main/hf-logo-with-title.png)
...
![Screenshot of the "Spaces" home page from HuggingFace showing various example Spaces that folks can duplicate.](images/huggingface_apps_list.png)
