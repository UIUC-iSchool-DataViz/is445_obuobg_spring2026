 ...
 * See whats in dev on the [bqplot gitter lobby](https://gitter.im/jupyter-widgets/Lobby)
...
* See [last week's Lecture](../week15/lecture14p1.html) for more Streamlit resources
* See [GitHub's listing for Jekyll Templates](https://github.com/topics/jekyll-theme) for other templates
* More [Jekyll resources on their Docs page](https://jekyllrb.com/tutorials/video-walkthroughs/) and [their Jekyll Resources page](https://jekyllrb.com/resources/)
* More with Altair for complex (geospatial, time evolving) data can be found on last week's/this week's Canvas Module (and available under each "Module" video on our MediaSpace channel)

notes:
**go to where to find modules on mediaspace channel!**

---

## Also, don't forget to fill out your FLEX forms!
