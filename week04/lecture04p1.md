...
<img src="../week04/images/data_viz_diagram_week3.png" alt="Mind-map of what was covered in class up to last week.  Includes data management, programming and visual encodings.">
...
<img src="images/data_viz_diagram_week4.png" alt="Mind-map of what we will cover in class this week.  Links visual encodings and programming together for beginning interactivity.">
...
<img src="images/find_channels.png" alt="Image of how to find channels in Slack -- click on dropdown arrow in Channels, go to Manage, then Browse channels.">
...
<div class="fig-container" data-style="height: 850px;" data-file="figures/hsv_space.html" data-markdown=true alt="A color picker widget with sliders for hue, saturation, value, C-cyan, M-magenta, Y-yelow,alpha-opacity, and kelvin temperature.">
</div>
...
<div class="fig-container" data-style="height: 600px;" data-file="figures/example_coloring_image.html" data-markdown=true alt="Widget to modify the red, green, and blue, and alpha channels for an uploaded image.">
</div>
...
<div class="fig-container" data-style="height: 640px;" data-file="figures/apply_colormap.html" data-markdown=true alt="Widget for scaling an image/dataset and applying a specific colormap.  The figure is scaled to a value 0-1 and then a colormap is applied.  The slider allows to set the 'bottom'/scale of the colorscale. ">
</div>
...
<img src="images/vehicles.jpg" width="700" alt="Image of cars driving on a freeway."/>
