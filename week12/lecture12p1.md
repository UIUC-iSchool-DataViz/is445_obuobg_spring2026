...
<img src="images/week12.png" alt="Mindmap of what we have covered up to this and last week.  Highlights include Jekyll, Altair, and Streamlit.">
...
We'll start discussing how to build and deploy some streamlit apps
 ...
 * There is a group-submission option for *parts* of the assignment.
...
<img src="images/inf_val.jpg" width="800" alt="Photograph of a member of the Advanced Visualization Lab at NCSA doing an in-person validation exercise with members of the publics for one of their documentaries.  Members of the public are viewing a snippet of a documentary and giving feedback."/>
...
<img src="images/cms.png" width="800" alt="Screenshots of the logos for several content managament systems (from left to right): SquareSpace, Wordpress, Wix, Drupal."/>
...
<img src="images/githubpages.jpeg" width="200" alt="Logo or GitHub pages content management system."/>
...
<img src="images/bloomberg.jpg" width="300" alt="Example of a two-desktop display running a custom bloomberg terminal."/>
...
<img src="images/prison.gif" width="800" alt="Gif of a graph that shows up from The 13th movie showing the US prison population over time."/>
...
<img src="images/museum.png" width="800" alt="A photo of two children interacting with a museum visualization of a tornado."/>
...
<img src="images/wwt.png" width="800" alt="A screenshot of the interface of the World Wide Telescope: worldwidetelescope.org"/>
...
<img src="images/blanketAndLeggings.png" width="800" alt="On the right: a photograph of a knitted blanket showing the range in temperatures over one year over time.  Hot is shown by lighter colors (red/yellow) and cold is shown by darker colors (blue/purple)."/>
