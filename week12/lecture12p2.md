---
title: Lecture 11.2 - A bit more info about Streamlit + HuggingFace
layout: lecture
description: >-
...
![A screenshot of VSCode with our first streamlit app.py file we started modifying in class (left) along side the preview of our app running (right).](images/app_py_file.png)
...
![Screenshot of an important part of the individual package/widget documentation -- how to select the documentation version.](images/widget_version.png)
...
**NOTE**: Recently Streamlit on HuggingFace has moved from the app setup we are using to a Docker-based setup so be sure you are looking at the correct documentation version!